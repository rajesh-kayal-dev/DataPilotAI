...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 h-16 px-4 md:px-6 flex items-center justify-between w-full border-b border-white/5 shrink-0 z-[9999] bg-black/10 backdrop-blur-md bg-gradient-to-b from-black/20 to-transparent">
      ...
      <div className="flex items-center gap-3">
        <div className="relative" ref={exportRef}>
          <button
            ...
            className="flex items-center gap-2 glass-card rounded-full px-4 py-1.5 text-white/90 hover:bg-white/10 transition-colors border border-white/5"
          >
          ...
          {isExportOpen && (
            <div className="absolute top-full mt-2 right-0 w-48 bg-[#1A1A24] border border-white/10 rounded-2xl py-2 z-[9999] shadow-2xl overflow-hidden backdrop-blur-xl">
